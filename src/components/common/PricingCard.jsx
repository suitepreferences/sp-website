...
function PricingCard({ title, price, period, features, buttonText, buttonClass, isPopular, onClick, originalPrice, badge }) {
  return (
    ...
    >
      ...
      <h3 className={`text-white text-3xl font-bold mb-2 text-center max-w-[280px] ${isPopular ? "mt-2" : ""}`}>{title}</h3>
      ...
      <ul className="text-gray-300 text-lg space-y-3 mb-8 w-full flex-grow">
        {" "}
        {/* Permanent gray-300 */}
