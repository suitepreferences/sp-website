      ...
      <div className="container mx-auto px-4 py-8 max-w-4xl">
        <h1 className="text-4xl font-bold mb-8 text-center text-sp-text-100">
          <span className="inline-block mx-2 align-[-.2em]">
            <ShieldCheck className="h-[1.1em] w-[1.1em] text-sp-success-400" />
          </span>
          Privacy Policy for SuitePreferences
        </h1>

        <div className="prose prose-invert max-w-none">
          <p className="text-sp-text-300 mb-6">
          ...
          <h2 className="text-2xl font-semibold mt-8 mb-4 text-sp-white">Information We Do Not Collect</h2>
          <p className="text-sp-text-300">SuitePreferences is designed with your privacy in mind. We do not collect, store, or transmit any personal data from your browsing activity, including:</p>
          <ul className="text-sp-text-300">
          ...
          <h2 className="text-2xl font-bold mt-8 mb-4 text-sp-text-100">Subscription Information</h2>
          <p className="text-sp-text-300">
          ...
          <h2 className="text-2xl font-semibold mt-8 mb-4 text-sp-white">Data Security</h2>
          <p className="text-sp-text-300">
          ...
          <h2 className="text-2xl font-semibold mt-8 mb-4 text-sp-white">Changes to This Privacy Policy</h2>
          <p className="text-sp-text-300">
          ...
          <h2 className="text-2xl font-semibold mt-8 mb-4 text-sp-white">Contact Us</h2>
          <p className="text-sp-text-300">If you have any questions about this Privacy Policy, please contact us:</p>
          <p className="text-sp-text-300">
            By email:{" "}
            <a href="mailto:support@suitepreferences.com" className="hover:underline text-sp-primary-400">
