      ...
      <section className="bg-indigo-700 text-white py-16 px-4 rounded-t-3xl shadow-xl">
        <div className="container mx-auto text-center max-w-3xl">
          ...
          <p className="text-xl mb-8 opacity-90">
            Join other users who are already enjoying a more personalized NetSuite experience.
          </p>
          <button
            onClick={handleGetExtensionClick}
  ...
  return (
    <div className={`bg-white p-8 rounded-xl shadow-lg flex flex-col items-center border-2 ${isPopular ? 'border-indigo-600 dark:border-indigo-400' : 'border-gray-100 dark:border-gray-700'} transition-all duration-300 hover:shadow-xl hover:scale-105 dark:bg-gray-800 dark:shadow-2xl`}>
      ...
      <div className="text-5xl font-extrabold text-indigo-600 mb-4 dark:text-indigo-400">
        ...
        {originalPrice && (
          <span className="text-xl font-light text-gray-500 dark:text-gray-400 line-through mr-2">{originalPrice}</span>
        )}
